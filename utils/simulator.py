...
camera_target = np.array([DEFAULT_FIELD.center[0], DEFAULT_FIELD.center[1], camera_pos[2]])        # Where the camera is looking (center of field) It would be good to transform this into an angle and assume verticality
...
DEFAULT_CAMERA = Camera(camera_pos, orientation, focal_length, img_width, img_height, fps = fps)